...
import Select from '../components/Select'; //importing the components use by the form
...
class FormContainer extends Component {  
  constructor(props) {
    ...
    this.state = {
      ownerName: '',
      petSelections: ['Dogs','Cats','Birds','Fish'],
      selectedPets: [],
...
/* FUNCTIONS CALL BY EVENTS */
  handleFullNameChange(e) {
    this.setState({ ownerName: e.target.value });
  }
  // in the property:"controlFunc"->updates the <FormContainer />'s state.
